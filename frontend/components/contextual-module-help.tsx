...
const moduleHelp: Record<string, HelpContent> = {
  ...
  "/customers": { title: "Fichas de personas", description: "reúne las fichas y el historial de las personas atendidas por tu operación. En inmobiliaria se presentan como Clientes y en salud como Pacientes.", steps: ["Busca o crea una ficha.", "Completa la información importante.", "Revisa su historial y próximos seguimientos."] },
